export default {
    ...
    dma: {
        banner: {
            title: 'MORE SERVICES',
            description: 'The IFU has joined forces with Hoolilaw, an overseas legal service platform, to launch the "365 study abroad family protection program" and hold a weekly free legal lecture. For just $1 a day, plan 365 offers the services of a professional lawyer who can help you solve legal problems in your daily life!',
            buttonText: "Contact Us",
    ...
    about: {
        ...
        story: {
            ...
            text1: 'We\'re consistently productive and productive: <span>470</span> articles and <span>282</span> original articles were published in 2018.',
            text2: 'We organized <span>11</span> offline events in 2018 around our culture and goals.',
            text3: 'We believe that a journey of a thousand miles begins with a single step: with constant efforts, we now have the attention of more than <span>6,000</span> parents, with an annual net growth of <span>5,219 +</span> , covering the whole of China.',
            text4: 'We used the vacation time to go back China. We went to <span>Shanghai, Wuxi, Changsha, Beijing, Shenzhen, Dalian</span> and other places, and invited psychological, physical, legal professionals to provide information to parents, to reduce questions and concerns.',
            text5: 'We are always concerned about the safety of studying abroad: the most read article on Wechat fraud emergency notice reached <span>8,000 +</span> views.',
            text6: 'We have <span>11</span> Professor Interview Video from different colleges, which has been professor interview related to a total of <span>7</span> articles.',
            text7: 'We are able to respond quickly in an emergency when parents ask for help: An emergency article gets more than <span>1,000 +</span> views per article in half an hour, and a maximum total reading of <span>10,000 +</span>',
            text8: 'WECHAT group senior from UCSD, UR, USC and other schools and professional teachers share once a week since September 2018. Total amount of shares reach at <span>57</span> times.',
            text9: 'In 2018, we helped four families find their missing children; <span>28</span> urgent notices were issued about the safety of the school\'s surroundings, alerting parents and students to possible safety hazards.',
            text10: 'Each school set up a weekly Wechat sharing from senior students which are deeply recognized and loved by parents.',
        },
        history: {
            '2017': {
                july: 'July 2017',
    ...
    isic: {
        banner: {
            ...
            description: 'International Student Identity Card, referred to as ISIC. This is a recognized universal student certificate，which was endorsed by the United Nations Educational, Scientific and Cultural Organization (UNESCO), issued by the International Student Travel Union (ISTC). Since its inception in 1953, more than 4 million students have enjoyed various international discounts, such as airfare, shopping, etc. Currently, there are more than 122 countries in the world with specialized organizations to provide tourist information and services.',
        ...
        colhalf: {
            ...
            becomeVipContent: "The purchase of an International Student ID (ISIC x IFU co-branded card) with an exclusive IFU logo can also be used to enjoy exclusive discounts on IFUs other than ISIC's own discounts, such as GRE training exclusive discounts, Student Universe",
            buttonText: 'List Your Offer',
            overView1: 'The IFU x ISIC joint international student card is the only international full-time student certification document recognized by UNESCO. It can enjoy more than 150,000 student discount benefits worldwide. At the same time, many discounts are exclusive benefits of the IFUxISIC card !! Card holders can enjoy discounts at over 21,000 restaurants and entertainment venues. Many international institutions also recognize ISIC x IFU joint student IDs, such as IELTS, and can enjoy a free pre-exam practice and advice.',
            overView2: '',
            overView3: '',
            overView4: '',
            overView5: '',
            overView6: '',
            overView7: '',
            overView8: 'In addition, there is free early consultation on legal services, and 20% discount on entrusted lawyer services later; 5% off on GRE postgraduate counselling; parents of students with international student IDs automatically become IFU members, and we will provide exclusive activities for member parents, such as The free online English classes offered on Wall Street before, free to learn practical spoken English, and don’t worry about children when you go abroad.',
            overView9: '',
            overView10: '',
            overView11: '',
            overView12: '',
        ...
        cardList: {
            imgDescription1: '50% discount on stays at hotels or private hotels nationwide',
            imgDescription2: '5% discount on UCSD bookstore and on-campus markets',
            imgDescription3: '10% discount on sports event tickets',
            imgDescription4: '50% discount on stays at hotels or private hotels nationwide',
            imgDescription5: '5% discount on UCSD bookstore and on-campus markets',
            imgDescription6: '10% discount on sports event tickets',
            imgDescription7: '50% discount on stays at hotels or private hotels nationwide',
            imgDescription8: '5% discount on UCSD bookstore and on-campus markets',
            ...
            imgDescription12: 'Free legal consultancy services 20% discount for lawyers',
        },
        tabList: {
    ...
    AI: {
        ...
        info: {
            ...
            leftContent: {
                ...
                text2: 'The strengths and limitations of making AI predict outcomes;',
                text3: 'How image recognition and data science can be applied to solve problems.',
                text4: '',
            },
            rightContent: {
        ...
        content: {
            ...
            text: '** If you have any question, feel free to contact us or scan the QR code at the bottom right corner to add IFU Wechat Assistant for more help.',
        }
    },
    modeling: {
        banner: {
        ...
        info: {
            ...
            rightContent: {
                ...
                text1: 'Simple models made of Polygon Primitives and advanced models using box modeling techniques;',
                text2: 'Sculptures of characters or creatures using Mudbox’s toolset;',
                text3: 'Several animations of a bouncing ball to display mastery of keyframes, weight, and timing;',
                text4: 'Images of characters in expressive poses, displaying subtle control of the complex character rigs;',
            },
        },
        content: {
            title: 'MORE ABOUT THIS COURSE',
    ...
    robot: {
        ...
        info: {
            ...
            leftContent: {
                ...
                text5: 'Command Line Interfaces and Python Coding Physical Computing;',
                text6: '',
            },
            rightContent: {
                title: 'What Students Create',
                ...
                text4: 'Projects that utilize the power of Python, Raspberry Pi, and the Internet;',
                text5: 'Basic code that they will be able to modify themselves for future projects;',
            },
        },
        content: {
            title: 'MORE ABOUT THIS COURSE',
    ...
    totoro: {
        banner: {
            ...
            description: 'Project Totoroad is an education project established by IFU to help international students, especially upcoming first-year undergraduates, to better transit from their previous lives and studies in high schools to the distinct, brand-new academic lives in universities and colleges faraway from home.',
        ...
        cohesion: {
            ...
            courseSetting1: 'All the bridging courses would be offered by carefully picked upper-class mentors, including Master students and Phd students. All these mentors are verified with a GPA of 4.0 in the corresponding courses and comes from Top 50 university/college in the world/America. Two kinds of class size can be selected: 4-6 student class and one-to-one class.',
            courseSetting2: '',
            courseSetting3: '',
            courseSetting4: '',
            courseSetting5: '',
        ...
        academic: {
            heading1: 'Class Overview',
            text1: 'In order to help students already studying in the universities to consolidate what they have learned and to get a better score, we also offer Totoroad synchronous tutoring. Mentors with GPA at 4.0 in the corresponding course or Master/ Phd students would come to you in a one-to-one class to help you study better. Courses are personally designed according to individuals’ needs to best fit into the path and weakness of the mentee. Mentors would help students either review the knowledge or analyze the difficult part or preview as preparations to lead to toward the better overall understanding and academic success.',
            text2: '',
            text3: '',
            text4: '',
            text5: '',
            text6: '',
            text7: '',
            text8: 'The subjects offer but not limit to right now are Math-Calculus, Physics, Chemistry, Computer Science-Java, Microeconomics, Macroeconomics.',
            text9: '',
            oneToone: '1 On 1 Class',
            smallGroup: '4-6 People Class',
            ...
            scanqr1: 'Contact IFU Wechat Assistant for consulting or signing up',
            scanqr2: '',
        },
        tutors: {
            ...
            joinTutor: "If your academic performance are good, you're willing to do valuable output and you're willing to trade your intellectual prowess for a part-time teaching job, welcome to join the Mentor team of IFU DORO PROJECT, this is where you can get to know a group of the nation's most academically gifted students! Fill in and submit the form carefully and wait for our knock!",
    ...
    contact: {
        banner: {
            title: 'CONTACT US',
            description: 'When the stars come together, they become a bright star. Thank you for your stay for even a moment, as well as your love for us, Ifu growth along the way, without your company and encouragement. We invite you to support the operation of IFU nonprofit organization and work together to build bridges between families studying abroad. Regardless of the amount, Ifu sincerely thanks you for your confidence in us!',
        },
        emergency: {
            ...
            p2: 'If your child is missing, IFU school volunteers will use the information in the emergency contact list to locate the child locally in the United States through school authorities, police, social media and other channels; after ensuring the safety of the child, IFU volunteers will communicate with the parents.',
    ...
    donation: {
        banner: {
            ...
            description: '“We invite you to support our operation of IFU nonprofit organization and work together to build bridges between families studying abroad. Regardless of the size of your donation, IFU sincerely thanks you for your trust!”',
            buttonText: 'Our Story',
        },
        support: {
            title: 'SUPPORT US',
            description: 'A donation from you will support the operation of IFU nonprofit Organization for one year and will help us build bridges between families studying abroad. Because of geography, jet lag, generation gap, the child\'s help feel helpless, anxious, do not be afraid, IFU in, there is hope.',
        },
        payment: {
            ...
            zelle: 'Search internationalfamilyunion@gmail.com through payment tools of banks for transfer',
        },
    },
    other: {
        otherService: {
            otherService1: 'Since 2019, the IFU has joined forces with Hoolilaw, an overseas legal service platform, to launch the ',
            otherService2: '365 study abroad family protection program ',
            otherService3: 'and hold a weekly free legal lecture. For just ',
            otherService4: '$1',
            otherService5: ' a day, plan 365 offers the services of a professional lawyer who can help you solve legal problems in your daily life!',
            otherService6: 'At the same time, ',
            otherService7: 'Tuoyan education',
            otherService8: ', recommended by IFU, specializes in american-based ',
            otherService9: 'GRE',
            otherService10: ' in Shanghai, providing high-quality professional training courses for students in the United States. Adhering to the concept of "you are responsible and serious, we are responsible for letting you win" , 63 percent of students with 320 or more points in the 2018 exam scored 325 or more in the first exam, 20 percent scored 330 or more in the first exam, and ',
            otherService11: 'the highest score was 338.',
            otherService12: '** Please scan the Qr Code in the bottom right corner of the page to add the assistant information for more information. ',
        },
        legalService: {
            ...
            legal3: ', to launch the "365 study abroad family protection program" and hold a weekly free legal lecture. For just $1 a day, plan 365 offers the services of a professional lawyer who can help you solve legal problems in your daily life!',
            legal4: 'The NYIS LAWFIRM, founded in 1979, began to focus on legal advice for international students in 2013, covering more than ',
            legal5: '200,000 consultations',
            legal6: ' in the US. Over the past two years, more than 65,000 legal advisory services have been completed. This includes visa related legal services, campus disputes, real estate disputes, traffic accidents, criminal cases, civil disputes, and other legal related cases. The Hoolilaw legal protection program covers four services: Regulatory Training, Legal Aid, personal security, and employment protection. In case of an emergency, ',
            legal7: 'the 365 Study Abroad Family Protection Program',
            legal8: " matches the child's assigned lawyer to help the child deal with the emergency on behalf of the parents. On average, for $1 a day, you can get counseling from a senior attorney.",
            legalLearnMoreBtn: 'Learn More',
        },
        greTraining: {
            trainingTitle: 'GRADUATE ENTRANCE TRAINING',
            training1: ' Shanghai Tuoyan Education',
            training2: 'As the leading GRE training institution in the United States, is committed to providing',
            training3: ' high-quality and professional GRE courses ',
            training4: 'for students studying in the United States. Excellent teachers and an attitude of refinement have enabled Tuoyan to cultivate a group of students who are satisfied with their scores.',
            training5: " 'Tuoyan's teacher is the most responsible GRE teacher I have ever encountered.",
            training6: " If you have any questions, I can respond quickly if we ask on WeChat. Thank you very much! Let me no longer worry about insufficient grades and no graduate Colleges can go! 'Said IFU senior sister. Thank you, Mr. Tuo Yan, for your full support during the education of IFU Charity Program. Thank you for growing up with IFU!",
