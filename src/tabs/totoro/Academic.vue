            ...
            <section class="row">
                <div class="col-half">
                    <div class="academic-image"> 
                        <img :src="syncDiagram" alt="image in academic section">
                    </div>
                </div>
                <div class="col-half">
                    <h2>{{ $t('totoro.academic.heading1')}}</h2>
                    <p>{{ $t('totoro.academic.text1') }}<b>{{ $t('totoro.academic.text2') }}</b>
                    {{ $t('totoro.academic.text3') }}<b>{{ $t('totoro.academic.text4') }}</b>
                    {{ $t('totoro.academic.text5') }}<b>{{ $t('totoro.academic.text6') }}</b>
                    {{ $t('totoro.academic.text7') }} 
                    </p>
                    <p>{{ $t('totoro.academic.text8') }}<b>{{ $t('totoro.academic.text9') }}</b></p>
                </div>
            </section>
