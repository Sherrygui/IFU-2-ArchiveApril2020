<template>
    <div>
        <section class="cohesion-section">
            <div class="row row-reverse">
                <section class="col-half col-half-center">
                    <h2>{{ $t('totoro.cohesion.heading1')}}</h2>
                    <p>{{ $t('totoro.cohesion.text1')}}<b>{{ $t('totoro.cohesion.description2')}}</b>{{ $t('totoro.cohesion.description3')}}<b>{{ $t('totoro.cohesion.description4')}}</b>{{ $t('totoro.cohesion.description5')}}<b>{{ $t('totoro.cohesion.description6')}}</b>{{ $t('totoro.cohesion.description7')}}<b>{{ $t('totoro.cohesion.description8')}}</b>{{ $t('totoro.cohesion.description9')}}<b>{{ $t('totoro.cohesion.description10')}}</b>{{ $t('totoro.cohesion.description11')}}<b>{{ $t('totoro.cohesion.description12')}}</b>{{ $t('totoro.cohesion.description13')}}</p>
                </section>
                <div class="col-half ">
                    <div class="cohesion-image"> 
                        <img :src="cohesionImage" alt="image in cohesion section">
                    </div>
                </div>
            </div>
            <div class="row light-blue-row">
                ...
                <section class="col-half smaller-half">
                    ...
                    <p>{{ $t('totoro.cohesion.subject1')}}<b>{{ $t('totoro.cohesion.subject2')}}</b>{{ $t('totoro.cohesion.subject3')}}</p>
                </section>
            </div>
             <div class="row row-reverse">
                <section class="col-half col-half-center">
                    <h2>{{ $t('totoro.cohesion.courseSettingHeading')}}</h2>
                    <p>{{ $t('totoro.cohesion.courseSetting1')}}<b>{{ $t('totoro.cohesion.courseSetting2')}}</b>{{ $t('totoro.cohesion.courseSetting3')}}<b>{{ $t('totoro.cohesion.courseSetting4')}}</b>{{ $t('totoro.cohesion.courseSetting5')}}<b>{{ $t('totoro.cohesion.courseSetting6')}}</b>。 </p>
                    <p>{{ $t('totoro.cohesion.courseSetting7')}}</p>
                </section>
                <div class="col-half ">
                    <div class="cohesion-image3"> 
                        <img :src="cohesionImage3" alt="image in cohesion section">
                    </div>
                </div>
            </div> 
            <div class="row group-class-row">
                ...
                <div class="col-half col-half-half col-flex">
                    ...
                    <div class="icon-register half-to-half group-top icon-one-to-more">
