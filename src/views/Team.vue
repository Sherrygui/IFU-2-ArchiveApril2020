<template>
    <div class="team-container">
        <Banner
            ...
            :image="teamImage"
            externalLink="https://mp.weixin.qq.com/s/f4UJoB2zt9fBTmfGFN1XCA"
        />
        ...
        <section class="container" v-for="(item, index) in profileList" :key="index">
            <h2>{{ item.title }}</h2>
            <Swiper :profileList="item.data" />
        </section>
    </div>
</template>
<script>
