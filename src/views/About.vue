<template>
    <div class="about">
        <Banner
            ...
            :buttonText="$t('about.banner.buttonText')"
            externalLink="https://www.wjx.top/m/42786146.aspx"
...
export default {
    ...
    computed:{
        tabList() {
            return ([{
                title: this.$t('about.tabList.story'),
                content: Story,
                color: '#F96291',
                defaultShow: true,
            }, {
                title: this.$t('about.tabList.culture'),
                content: Culture,
                color: '#34BBC9',
            }, {
                title: this.$t('about.tabList.progress'),
                content: History,
                color: '#C9D74A',
            }, {
                title: this.$t('about.tabList.team'),
                content: Team,
                color: '#F96291',
            }]);
        }
